  ...
  <div class="page-main-header" :class="{'close_icon': $store.state.showSidebarMenu}">
        <div class="main-header-right row m-0">
            ...
            <ul class="nav-menus">
                ...
                <li class="onhover-dropdown">
                <div class="notification-box"><i class="fa fa-bell-o"></i><span class="dot-animated"></span></div>
                <ul class="notification-dropdown onhover-show-div">
                    ...
                    <div class="media"><span class="notification-bg bg-light-danger"><i class="fa fa-heart"> </i></span>
                        <div class="media-body">
                ...
                <li class="onhover-dropdown"><i class="fa fa-user"></i>
                ...
                <button class="btn btn-primary-light" type="button"><a href="login_two.html"><i class="fa fa-sign-out me-1"></i>Log out</a></button>
                </li>
            </ul>
            </div>
